...
<html lang="en">
    ...
    <body class="flex bg-mdaWhite bg-gradient-to-t from-mdaGreen_400 to-mdaWhite">
        ...
        <nav class="bg-white p-7 shadow-md sticky top-0 h-screen z-10">
            <div class="grid gap-y-5">
                ...
                <div>
                    ...
                    <% if (session.getAttribute("instructor") != null || session.getAttribute("monitor") != null) { %>
                    <!-- Notificaciones -->
                    <a href="#">
                        <button
                            id="showModal-2"
        ...
        <section
            class="m-auto flex w-full max-w-screen-2xl min-h-screen justify-center p-5 gap-5 flex-wrap content-start"
            >
            <!-- Artículo -->
            <article
                class="bg-white w-full max-w-2xl h-40 shadow-md rounded-lg p-5 flex flex-col justify-between"
                >
                ...
                <div class="text-mdaGreen">
                    ...
                    <a class="text-base hover:underline" href="#"
        ...
        <button
            ...
            <%
                ...
                if (session.getAttribute("instructor") != null) {
                    rol = "Instructor";
                } else if (session.getAttribute("monitor") != null) {
                    rol = "Monitor";
                } else if (session.getAttribute("aprendiz") != null) {
                    rol = "Aprendiz";
                } else {
                    rol = "Invitado";
                }

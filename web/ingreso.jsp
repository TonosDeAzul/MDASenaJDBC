...
<%
    ...
    if (sesion != null && sesion.getAttribute("aprendiz") != null) {
        ...
        <section class="grid bg-white p-7 rounded-lg shadow-md w-full">
            ...
            <form action="svUsuario?accion=verificar" method="POST" class="grid">
                <label class="bg-white text-mdaBlack input input-bordered flex items-center gap-2 mb-4">
                    ...
                    <input name="correoInstitucional" type="text" class="grow text-mdaBlack" placeholder="Correo institucional" />
                </label>
                <label class="bg-white text-mdaBlack input input-bordered flex items-center gap-2">
                    ...
                    <input name="password" type="password" class="grow text-mdaBlack" placeholder="Contraseña" />
                </label>
                <p class="text-sm text-right mt-1 text-mdaGreen hover:underline">
                    <a href="#">¿Olvidó su contraseña?</a>
                </p>
                <button type="submit" name="verificar" value="verificar" class="btn bg-mdaGreen border-none text-white mt-4 hover:bg-mdaGreen">
                    Ingresar
                </button>
            </form>
            <div class="flex justify-center gap-2 text-xs">
                <p class="text-sm text-center mt-1 text-mdaBlack">
                    ...
                    <a class="text-mdaGreen hover:underline" href="#">Regístrese</a>
                </p>
        </section>
